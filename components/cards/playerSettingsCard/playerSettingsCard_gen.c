...
#include "playerSettingsCard_gen.h"
#include "Monopoly.h"
...
lv_obj_t * playerSettingsCard_create(lv_obj_t * parent)
{
    ...
    lv_label_set_translation_tag(lv_label_0, "player_settings");
