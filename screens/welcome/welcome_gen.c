...
lv_obj_t * welcome_create(void)
{
    ...
    lv_obj_add_screen_load_event(button_0, LV_EVENT_CLICKED, game_start, LV_SCR_LOAD_ANIM_NONE, 0, 0);
    ...
    lv_obj_add_screen_load_event(button_1, LV_EVENT_CLICKED, settings, LV_SCR_LOAD_ANIM_NONE, 0, 0);
